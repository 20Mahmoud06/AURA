...
class VideoPlaylistsPage extends StatelessWidget {
  const VideoPlaylistsPage({super.key});
                ...
                builder: (context, state) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final items = state.videoItems.where((v) => playlist.itemPaths.contains(v.path)).toList();
                      return PlaylistCard(
                        title: playlist.name,
                        subtitle: '${items.length} videos',
                        videoAssetId: items.isNotEmpty ? items.first.assetId : null,
